...
class TextBuilder extends StatelessWidget {
  const TextBuilder({super.key, required this.controller});
    ...
    return controller.editing
        ...
        : TextResponseWidget(
            controller: FieldResponseController(
              spec,
              true,
              FormFieldResponse.text('Lorem ipsum'),
            ),
          );
  }
}
...
class _Editor extends StatelessWidget {
  ...
  void _onUpdate({
    ...
    final C4TextFormField subspec = spec.textRequired;
    onUpdate(C4FormField.text(C4TextFormField(
      key: key ?? subspec.key,
